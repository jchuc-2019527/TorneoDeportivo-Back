    ...
    try {
        ...
        if(permission ===true){
            ...
            if(checkData ===true){
                ...
                if(!team){
                    const teamUpdate = await Team.findOneAndUpdate({_id: teamId}, {name: params.name}, {new:true});
...
exports.getTeams = async(req, res)=>{
    try {
        ...
        return res.status(200).send(await orderTeams(teams));
